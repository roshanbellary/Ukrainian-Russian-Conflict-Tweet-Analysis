...
```{r}
emote_count  <- table(tweets$Emotion,tweets$Country)
emote_count <- addmargins(bplot)
emote_counts <- as.data.frame(emote_count)
emote_counts
emote_counts_anger <- emote_counts %>% filter(Var1=="anger")
emote_counts_fear <- emote_counts %>% filter(Var1=="fear")
emote_counts_joy <- emote_counts %>% filter(Var1=="joy")
emote_counts_neutral <- emote_counts %>% filter(Var1=="neutral")
emote_counts_sadness <- emote_counts %>% filter(Var1=="sadness")
country_distbr <- data.frame(emote_counts_anger$Var2, emote_counts_anger$Freq,emote_counts_fear$Freq, emote_counts_joy$Freq,emote_counts_neutral$Freq, emote_counts_sadness$Freq)
colnames(country_distbr) <- c("Country","Anger","Fear","Joy","Neutral","Sadness")
emote_counts_anger
country_distbr
write.csv(country_distbr,"./distr_country_emotions.csv")
```
...
par(mfrow=c(2,3))
colourPalette <- brewer.pal(100,'Reds')
anger_map <- data.frame("country"=emote_counts_anger$Var2, "x"=emote_counts_anger$Freq)
matched <- joinCountryData2Map(anger_map, joinCode="NAME", nameJoinColumn="country")
anger_mapParams <- mapCountryData(matched,catMethod= legend.limits, 
                            nameColumnToPlot="x", 
                            mapTitle="Anger Map",
                            addLegend=FALSE
...
,legendMar = 4))
colourPalette <- brewer.pal(100,'Blues')
sadness_map <- data.frame("country"=emote_counts_sadness$Var2, "x"=emote_counts_sadness$Freq)
matched <- joinCountryData2Map(sadness_map, joinCode="NAME", nameJoinColumn="country")
sadness_mapParams <- mapCountryData(matched, catMethod= legend.limits,
                            nameColumnToPlot="x", 
                            mapTitle="Sadness Map",
                            addLegend=FALSE
                            ,colourPalette=colourPalette,
                            oceanCol="#404040", missingCountryCol="#A0A0A0")
do.call(addMapLegend
...
,legendIntervals="data"
,legendMar = 4))
colourPalette <- brewer.pal(100,'Purples')
fear_map <- data.frame("country"=emote_counts_fear$Var2, "x"=emote_counts_fear$Freq)
matched <- joinCountryData2Map(fear_map, joinCode="NAME", nameJoinColumn="country")
fear_mapParams <- mapCountryData(matched, catMethod= legend.limits,
                            nameColumnToPlot="x", 
                            mapTitle="Fear Map",
                            addLegend=FALSE
                            ,colourPalette=colourPalette,
...
,legendIntervals="data"
,legendMar = 4))
colourPalette <- brewer.pal(100,'YlOrRd')
joy_map <- data.frame("country"=emote_counts_joy$Var2, "x"=emote_counts_joy$Freq)
matched <- joinCountryData2Map(fear_map, joinCode="NAME", nameJoinColumn="country")
joy_mapParams <- mapCountryData(matched, catMethod= legend.limits,
                            nameColumnToPlot="x", 
                            mapTitle="Joy Map",
                            addLegend=FALSE
                            ,colourPalette=colourPalette,
...
,legendIntervals="data"
,legendMar = 4))
colourPalette <- brewer.pal(100,'Greys')
neutral_map <- data.frame("country"=emote_counts_neutral$Var2, "x"=emote_counts_neutral$Freq)
matched <- joinCountryData2Map(neutral_map, joinCode="NAME", nameJoinColumn="country")
neutral_mapParams <- mapCountryData(matched, catMethod= legend.limits,
                            nameColumnToPlot="x", 
                            mapTitle="Neutral Map",
                            addLegend=FALSE
                            ,colourPalette=colourPalette,
                            oceanCol="#404040", missingCountryCol="#A0A0A0")
do.call(addMapLegend
